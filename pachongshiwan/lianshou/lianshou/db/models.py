...
class XiaoShuo(Base):
    __tablename__ = "qidianxiaoshuo"
    id = Column(Integer, primary_key=True)  # db can set it auto_increment
    book_title = Column(String(200))
    book_Author = Column(String(20))
    book_Author_img = Column(String(200))
    book_type = Column(String(200))
    book_img = Column(String(200))
    book_tag = Column(String(300))
    book_ticket = Column(String(200))
